...
export PHASE COMPARISON_FRAMING GPU_BUDGET GPU_E GPU_P GPU_D
export MODEL PORT FULL_DISAGG_LAUNCH_CMD
...
out = {
    ...
    "gpu_mapping": {
        ...
        f"gpu{os.environ['GPU_P']}": "prefill",
        f"gpu{os.environ['GPU_D']}": "decode"
    },
    "model": os.environ["MODEL"],
    "port": int(os.environ["PORT"]),
    "launcher": os.environ["FULL_DISAGG_LAUNCH_CMD"],
...
export USE_SERVER_TOKEN_COUNT REQUIRE_ENDPOINT_READY RUN_DIR LOG_DIR
...
out = {
    ...
    "prefill_gpu": os.environ["GPU_P"],
    "decode_gpu": os.environ["GPU_D"],
    "require_endpoint_ready": os.environ["REQUIRE_ENDPOINT_READY"],
...
echo "Phase 3 full E/P/D run complete."
echo "RUN_DIR=$RUN_DIR"
